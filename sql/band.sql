...
return case
    ...
    when freq between 1.8 and 2.0           then '160m' -- lower end rounded down
    when freq between 3.5 and 4.0           then '80m'
    when freq between 5.102 and 5.4065      then '60m'
    when freq between 7.0 and 7.3           then '40m'
    when freq between 10.0 and 10.15        then '30m' -- lower end rounded down
    when freq between 14.0 and 14.35        then '20m'
    when freq between 18.0 and 18.168       then '17m' -- lower end rounded down
